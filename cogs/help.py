...
class DropdownHelp(commands.Cog):
    ...
    async def help_command(self, ctx):
        ...
        categories = {
            ...
            "AntiNuke": [
                "!whitelist <member> - Add to whitelist",
                "!unwhitelist <member> - Remove from whitelist",
                "!setlogs <channel> - Set AntiNuke log",
                "!lockdown on/off - Enable lockdown"
            ],
            "AntiRaid": [
                "!whitelist-r <member> - Add to whitelist",
                "!unwhitelist-r <member> - Remove from whitelist",
                "!setlogs-r <channel> - Set AntiRaid log",
                "!lockdown-r on/off - Enable lockdown"
            ]
        }
