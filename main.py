...
COGS4 = ["admin", "help", "fun", "world", "utilities", "hrm", "antinuke", "antiraid", "server", "PingResponder", "snipe", "list", "blacklist"]
...
async def main():
    async with bot:
        ...
        await bot.start("YOUR-BOT-TOKEN")  # Replace with your bot token
